...
<html>
  ...
  -----> 
  <head>
	<link rel="icon" type="image/x-icon" href="../../Immagini/Icone/index.ico">
    <meta charset="utf-8">
  ...
  <body class="bodyIndex">
    ...
    document.getElementById("demo").innerHTML = "Inizio asta tra:" + days + "d " + hours + "h "+ minutes + "m " + seconds + "s ";
        ...
        <ul>
		  ...
		  <?php
			if(!isset($_SESSION['username'])){
				echo "<li><a href=\"../Registrazione/registrazione.php\">Registrazione</a></li>";
	 ...
	 <div id="quadro_centro">
	    <p id="demo"></p>
		<img id="quadro_centrato" src="../../Immagini/Quadri/Nighthawks_Hopper.jpg"></img>
	 </div>
