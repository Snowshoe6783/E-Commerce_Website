...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2022 at 07:46 PM
...
(70, 54, NULL, NULL, NULL, '2022-04-18 19:39:20', '2022-04-18 19:40:37', '2022-04-18 19:40:37', NULL, NULL);
...
(2, '3 Maggio', 'Francisco Goya', 'Spagna', 'Romanticismo', 'interessante', 'molto molto molto interessante', 100, 10, '3-Maggio_Goya.jpg', 0),
(3, 'Ascesa all\'Empireo', 'Hieronymus Bosch', 'Paesi Bassi', 'Rinascimento', 'wow', 'wowowowowoowowowow', 250, 979, 'Ascesa-all\'Empireo_Bosch.jpg', 0),
(4, 'Camille Monet sul letto di mor', 'Claude Monet', 'Francia', 'Impressionismo', 'lol', 'omega lol', 5, 16, 'Camille-Monet-sul-letto-di-morte_Monet.jpg', 0),
(5, 'Centauro Maniscalco', 'Arnold Böcklin', 'Svizzera', 'Simbolismo', 'centauro ', 'centauro centauro', 75, 12, 'Centauro-Maniscalco_Bocklin.jpg', 0),
(6, 'Mangiatori di patate', 'Vincent van Gogh', 'Paesi Bassi', 'Impressionismo', 'wooooooooow', 'aaaaaaaaaaaaaaaaaaaaaaaaaawwwwwwwwwwwwwwwwwwwwwaaaaaaaa', 1000, 550, 'Mangiatori-di-patate_Vincent-van-Gogh.jpg', 0),
...
(20, 'Il Ciclista', 'Natalia Goncharova', 'Russia', 'Futurismo', 'Bici', 'Mega Ultra Bici', 50, 40, 'd799664e3af35b328fdc2eacfdf717b2.jpg', 0),
...
--
ALTER TABLE `acquisto`
  MODIFY `prodotto_carrello_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `ordine`
  MODIFY `ordine_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
