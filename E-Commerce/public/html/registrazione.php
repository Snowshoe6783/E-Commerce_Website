...
<body class="bodyRegistrazione">
	<form method="post" name="myform">
		...
		<div class="div_registrazione">
			...
			<label for="nome_field">Nome <input class="input_registrazione" type="text" name="nome" required></label><br>
			<label for="nome_field">Cognome <input class="input_registrazione" type="text" name="cognome" required></label><br>
			<label for="nome_field">Ruolo <input class="input_registrazione" type="text" name="ruolo_id" required></label><br>
			<label for="nome_field">Codice Fiscale <input class="input_registrazione" type="text" name="codice_fiscale" required></label><br>
			<label for="nome_field">E-mail <input class="input_registrazione" type="text" name="email" required></label><br>
			<label for="nome_field">Indirizzo <input class="input_registrazione" type="text" name="indirizzo" required></label><br>
			<label for="nome_field">Numero di telefono <input class="input_registrazione" type="text" name="numero_telefono" required></label>
		</div>
		<div class="div_registrazione">
